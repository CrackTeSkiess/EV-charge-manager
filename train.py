...
def parse_args():
    ...
    parser.add_argument('--run-name', type=str, default=None, help='Human-readable name for this run')
...
def main():
    ...
    with open(run_dir.data_path("config.json"), 'w') as f:
    ...
    try:
        trainer.train(
            ...
            save_dir=run_dir.models_dir,
            history_dir=run_dir.data_dir,
        )
    except KeyboardInterrupt:
        print("\nTraining interrupted by user")
        trainer.save(run_dir.model_path("interrupted_model.pt"))
    ...
    # Save results
    with open(run_dir.data_path("results.json"), 'w') as f:
        json.dump({
