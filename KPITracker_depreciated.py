...
class KPITracker:
    ...
    def record_step(
        ...
        total_entered = environment.stats['total_entered']
        total_exited = environment.stats['total_exited']
        completion_rate = total_exited / max(1, total_entered)
    ...
    def _count_quit_waiting(self, highway: Any, step_events: Dict) -> int:
        ...
        for area_id, area in highway.charging_areas.items():
            ...
            for vid in left_queue:
                ...
                if vehicle and vehicle.state != VehicleState.CHARGING: # pyright: ignore[reportUndefinedVariable]
                    quit_count += 1
