...
from ChargingAreaEnv import MultiAgentChargingEnv, CostParameters, WeatherProfile
from PPOTrainer import MultiAgentPPO
from EnergyManagerAgent import EnergyManagerAgent, GridPricingSchedule
    ...
    def train_episode(self, episode_idx: int) -> Dict:
        ...
        for station_idx, agent in enumerate(self.agents):
            ...
            for hour in range(24):
                ...
                # Update battery SOC
                battery_change = flows['battery_power'] * (1/24)  # 1 hour
...
class HierarchicalTrainer:
    ...
    def train_sequential(self) -> Dict:
        ...
        # Create macro trainer with FROZEN micro-agents
        # The micro-agents are loaded but not updated during macro training
        self.env.enable_micro_rl = True  # Use micro-RL for control
        
        # Inject pre-trained micro policies into environment
        # (This happens automatically when HierarchicalEnergyManager is created)
